...
4. "How do statutory employee benefit obligations in [country] differ from the acquiring company's home-country practices?"
...
4. "Build a country-specific Day 1 communication plan for [country] that satisfies local legal notice requirements."
...
4. "What integration risks are unique to [country] that wouldn't appear in a generic global integration checklist?"
...
3. "Design a tracking system for country-specific integration milestones and legal deadlines across [number] markets."
4. "How do we escalate a conflict between two countries' legal requirements that create competing integration timelines?"
