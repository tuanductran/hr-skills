...
export default function HomePage() {
	return (
		<main className='landing-shell'>
			<header className='landing-container flex items-center justify-between py-6 sm:py-8'>
				<Link
					href='/'
				...
				<Link
					...
					className='rounded-full border border-[var(--ink)] px-4 py-2 text-sm font-bold transition hover:bg-[var(--ink)] hover:text-white'>
					View on GitHub
				</Link>
			</header>
			...
			<section className='landing-container grid gap-12 pb-20 pt-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end lg:pb-32 lg:pt-24'>
				<div>
					...
					<p className='mt-8 max-w-xl text-lg leading-8 text-slate-600 sm:text-xl'>
						HR Skills is a practical knowledge system for the questions behind
						better teams — searchable, composable, and grounded in a canonical
						library.
					</p>
					...
					<div className='relative flex h-full flex-col justify-between'>
						...
						<div>
							...
							<p className='mt-6 max-w-sm text-sm leading-6 text-blue-100'>
								A durable layer between the question your team asks and
								the next action you can explain.
							</p>
						</div>
				...
				<div className='grid gap-10 lg:grid-cols-[0.7fr_1.3fr]'>
					...
					<div>
						<p className='max-w-2xl text-xl leading-8 text-slate-600'>
							People work rarely arrives as a neat category. It arrives as a
							messy question with a deadline. HR Skills makes the useful
							parts easier to find, connect, and carry into a real
							conversation.
						</p>
						<div className='mt-10 grid gap-3 sm:grid-cols-2'>
							{domains.map((domain, index) => (
								<Link
									key={domain}
									href='https://github.com/tuanductran/hr-skills/tree/dev/skills'
			...
			<section
				...
				<div className='grid gap-8 lg:grid-cols-[1fr_1.2fr]'>
					...
					<div className='grid gap-4 sm:grid-cols-2'>
						<Link
							href='https://github.com/tuanductran/hr-skills/tree/feat/jd-builder'
							...
							<p className='mt-4 text-sm leading-6 text-slate-500'>
								Structured, inclusive job descriptions from role context
								to export.
							</p>
