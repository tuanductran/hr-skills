...
- [hr-skills — cli](#hr-skills--cli)
- [hr-skills-build — server](#hr-skills-build--server)
  - [`humanizeIdentifier`](#humanizeidentifier)
  - [`buildDocumentationData`](#builddocumentationdata)
  - [`runCase`](#runcase)
  - [`diffAgainstGolden`](#diffagainstgolden)
  - [`computeQualityMetrics`](#computequalitymetrics)
  - [`runEvaluation`](#runevaluation)
  - [`toGoldenFixture`](#togoldenfixture)
  - [`loadDataset`](#loaddataset)
  - [`loadAllDatasets`](#loadalldatasets)
  - [`loadGoldenFixture`](#loadgoldenfixture)
  - [`saveGoldenFixture`](#savegoldenfixture)
  - [`listGoldenFixtureNames`](#listgoldenfixturenames)
  - [`loadAllGoldenFixtures`](#loadallgoldenfixtures)
  - [`discoverSkills`](#discoverskills)
  - [`dirExists`](#direxists)
  - [`countFiles`](#countfiles)
  - [`EVAL_DATASETS_DIR`](#eval_datasets_dir)
  - [`EVAL_GOLDEN_DIR`](#eval_golden_dir)
  ...
  - [`createRegistryCache`](#createregistrycache)
  - [`createEvaluationCache`](#createevaluationcache)
  - [`ServiceLogLevel`](#serviceloglevel)
  - [`ServiceLogEvent`](#servicelogevent)
  - [`ServiceLogSink`](#servicelogsink)
  - [`StructuredServiceLogger`](#structuredservicelogger)
  - [`createStructuredLogger`](#createstructuredlogger)
  - [`ServiceMetricSnapshot`](#servicemetricsnapshot)
  - [`ServiceMetrics`](#servicemetrics)
  - [`createServiceMetrics`](#createservicemetrics)
  - [`ReadinessCheck`](#readinesscheck)
  - [`ReadinessStatus`](#readinessstatus)
  - [`ReadinessDependency`](#readinessdependency)
  - [`getReadinessService`](#getreadinessservice)
  - [`SkillClassification`](#skillclassification)
  - [`classifySkill`](#classifyskill)
  - [`CategoryMeta`](#categorymeta)
  - [`CATEGORY_META`](#category_meta)
  - [`getHrSkills`](#gethrskills)
  - [`loadRelevanceSignalTable`](#loadrelevancesignaltable)
  - [`buildRegistry`](#buildregistry)
  - [`computeTier`](#computetier)
  - [`tierIcon`](#tiericon)
  - [`tierLabel`](#tierlabel)
  - [`stubStepExecutor`](#stubstepexecutor)
  - [`successResponse`](#successresponse)
  - [`failureResponse`](#failureresponse)
  - [`getHealthService`](#gethealthservice)
  - [`getVersionService`](#getversionservice)
  - [`searchRegistryService`](#searchregistryservice)
  ...
  - [`WEIGHT_BIGRAM`](#weight_bigram)
  - [`DUPLICATE_THRESHOLD`](#duplicate_threshold)
  - [`HR_STOP_WORDS`](#hr_stop_words)
  - [`tokenise`](#tokenise)
  ...
  - [`EXAMPLE_COVERAGE_WEIGHT`](#example_coverage_weight)
  - [`QUALITY_BAND_THRESHOLDS`](#quality_band_thresholds)
  - [`QualityBand`](#qualityband)
  - [`QualityDimensionScore`](#qualitydimensionscore)
  - [`SkillQualityScore`](#skillqualityscore)
  - [`scoreClarity`](#scoreclarity)
  - [`scoreCompleteness`](#scorecompleteness)
  - [`scoreExampleCoverage`](#scoreexamplecoverage)
  - [`scoreSkillQuality`](#scoreskillquality)
  - [`scoreAllSkills`](#scoreallskills)
  - [`scoreSkills`](#scoreskills)
  - [`validateSecurityCommands`](#validatesecuritycommands)
  - [`validateSensitivePaths`](#validatesensitivepaths)
  - [`validateSuspiciousUrls`](#validatesuspiciousurls)
  - [`validateCredentialLeaks`](#validatecredentialleaks)
  - [`validateHiddenUnicode`](#validatehiddenunicode)
  - [`validateSecurityChecks`](#validatesecuritychecks)
  - [`PROMPT_DRIFT_THRESHOLD`](#prompt_drift_threshold)
  - [`EXAMPLE_DRIFT_THRESHOLD`](#example_drift_threshold)
  - [`COPY_MARGIN`](#copy_margin)
  - [`COPY_MIN_OTHER_SCORE`](#copy_min_other_score)
  - [`MIN_COVERAGE_RATIO`](#min_coverage_ratio)
  - [`MIN_PURPOSE_TOKENS`](#min_purpose_tokens)
  - [`SkillSemanticContent`](#skillsemanticcontent)
  - [`loadSkillSemanticContent`](#loadskillsemanticcontent)
  - [`topKeywords`](#topkeywords)
  - [`SemanticFinding`](#semanticfinding)
  - [`checkDrift`](#checkdrift)
  - [`checkPossibleCopy`](#checkpossiblecopy)
  - [`checkConceptCoverage`](#checkconceptcoverage)
  - [`validateSemanticConsistency`](#validatesemanticconsistency)
  - [`validateExecutionPlan`](#validateexecutionplan)
  - [`suggestPlanImprovements`](#suggestplanimprovements)
  - [`validateRegistryConsistency`](#validateregistryconsistency)
  - [`validateRelatedSkillsAgainstSignals`](#validaterelatedskillsagainstsignals)
  - [`validateFrontmatter`](#validatefrontmatter)
  - [`validateRequiredSections`](#validaterequiredsections)
  - [`validateContentLength`](#validatecontentlength)
  - [`validateLineCount`](#validatelinecount)
  - [`validateSupportedTasks`](#validatesupportedtasks)
  - [`validateTips`](#validatetips)
  - [`validateBlankLines`](#validateblanklines)
  - [`validateAuthor`](#validateauthor)
  - [`validatePromptStructure`](#validatepromptstructure)
  - [`validateRouterConsistency`](#validaterouterconsistency)
  - [`validateSubdirectoryContents`](#validatesubdirectorycontents)
  - [`GITHUB_BLOB_BASE_URL`](#github_blob_base_url)
  - [`TASK_ITEM_REGEX`](#task_item_regex)
  - [`HR_SKILL_PREFIX`](#hr_skill_prefix)
  - [`KEY_PROMPTS_REGEX`](#key_prompts_regex)
  - [`QUOTED_PROMPT_REGEX`](#quoted_prompt_regex)
  - [`USE_WHEN_REGEX`](#use_when_regex)
  - [`PERIOD_REGEX`](#period_regex)
  - [`FRONTMATTER_REGEX`](#frontmatter_regex)
  - [`TASKS_REGEX`](#tasks_regex)
  - [`REQUIRED_SECTIONS`](#required_sections)
  - [`MIN_DESCRIPTION_LENGTH`](#min_description_length)
  - [`MIN_CONTENT_LENGTH`](#min_content_length)
  - [`TIPS_REGEX`](#tips_regex)
  - [`SKILL_LINK_REGEX`](#skill_link_regex)
  ...
  - [`MarketplaceJsonSchema`](#marketplacejsonschema)
  - [`SkillFrontmatterSchema`](#skillfrontmatterschema)
  - [`SkillFrontmatter`](#skillfrontmatter)
  - [`SKILL_CATEGORIES`](#skill_categories)
  - [`RegistrySchema`](#registryschema)
  - [`UnknownSkillError`](#unknownskillerror)
  - [`getRecommendations`](#getrecommendations)
  - [`RelevanceSignal`](#relevancesignal)
  - [`RelevanceSignalTable`](#relevancesignaltable)
  - [`extractCoSelectionCounts`](#extractcoselectioncounts)
  - [`extractSkillObservationCounts`](#extractskillobservationcounts)
  - [`computeSignals`](#computesignals)
  - [`buildRelevanceSignalTable`](#buildrelevancesignaltable)
  - [`indexSignalsBySource`](#indexsignalsbysource)
  - [`reRankRelatedSkills`](#rerankrelatedskills)
  - [`RELEVANCE_SIGNAL_SCHEMA_VERSION`](#relevance_signal_schema_version)
  - [`OBSERVED_WEIGHT`](#observed_weight)
  - [`FIELD_WEIGHTS`](#field_weights)
  - [`ALL_SEARCHABLE_FIELDS`](#all_searchable_fields)
  - [`InvalidSearchQueryError`](#invalidsearchqueryerror)
  ...
  - [`ServiceErrorContract`](#serviceerrorcontract)
  - [`ServiceSuccessContract`](#servicesuccesscontract)
  - [`ServiceFailureContract`](#servicefailurecontract)
  - [`ServiceEnvelope`](#serviceenvelope)
  - [`getServiceContract`](#getservicecontract)
  - [`SearchRequestSchema`](#searchrequestschema)
  - [`PlannerRequestSchema`](#plannerrequestschema)
  - [`SearchRequestInput`](#searchrequestinput)
  - [`PlannerRequestInput`](#plannerrequestinput)
  - [`ServiceErrorCode`](#serviceerrorcode)
  - [`ServiceError`](#serviceerror)
  - [`ServiceResponseMeta`](#serviceresponsemeta)
  - [`ServiceResponseSuccess`](#serviceresponsesuccess)
  - [`ServiceResponseFailure`](#serviceresponsefailure)
  - [`ServiceResponse`](#serviceresponse)
  - [`HealthStatus`](#healthstatus)
  - [`VersionInfo`](#versioninfo)
  - [`PlannerServiceResult`](#plannerserviceresult)
  - [`ExecuteWorkflowServiceOptions`](#executeworkflowserviceoptions)
  - [`SkillCategory`](#skillcategory)
  - [`Tier`](#tier)
  - [`SkillRow`](#skillrow)
  - [`SkillDirectoryOptions`](#skilldirectoryoptions)
  - [`SkillMeta`](#skillmeta)
  - [`SkillValidationIssue`](#skillvalidationissue)
  - [`RegistryEntry`](#registryentry)
  - [`SkillRecommendation`](#skillrecommendation)
  - [`RecommendationResult`](#recommendationresult)
  - [`SearchableField`](#searchablefield)
  - [`MatchType`](#matchtype)
  - [`SkillFieldMatch`](#skillfieldmatch)
  - [`SkillSearchResult`](#skillsearchresult)
  - [`SkillSearchQuery`](#skillsearchquery)
  - [`SkillSearchResponse`](#skillsearchresponse)
  - [`Registry`](#registry)
  - [`SelectionReason`](#selectionreason)
  - [`ExecutionStep`](#executionstep)
  - [`CapabilityMatch`](#capabilitymatch)
  - [`ExecutionPlan`](#executionplan)
  - [`PlanValidationIssue`](#planvalidationissue)
...
- [hr-skills-build — client](#hr-skills-build--client)
  ...
  - [`QualityMetrics`](#qualitymetrics)
  - [`EvaluationReport`](#evaluationreport)
- [hr-skills-ref — server](#hr-skills-ref--server)
  - [`ROOT_DIR`](#root_dir)
  - [`SKILLS_DIR`](#skills_dir)
  - [`createSkillBlock`](#createskillblock)
  - [`discoverSkillNames`](#discoverskillnames)
  - [`makeTempSkill`](#maketempskill)
  - [`findSkillMd`](#findskillmd)
  - [`readProperties`](#readproperties)
  - [`toPrompt`](#toprompt)
  - [`validate`](#validate)
  - [`ALLOWED_TOOLS_KEY`](#allowed_tools_key)
  - [`FRONTMATTER_DELIMITER`](#frontmatter_delimiter)
  - [`SKILL_MD_FILENAMES`](#skill_md_filenames)
  ...
  - [`ALLOWED_FRONTMATTER_FIELDS`](#allowed_frontmatter_fields)
  - [`XML_ESCAPES`](#xml_escapes)
  - [`SkillError`](#skillerror)
  - [`ParseError`](#parseerror)
  - [`ValidationError`](#validationerror)
  - [`isPlainObject`](#isplainobject)
  - [`toStringOrUndefined`](#tostringorundefined)
  - [`sanitizeYamlValue`](#sanitizeyamlvalue)
  - [`toDict`](#todict)
  - [`parseFrontmatter`](#parsefrontmatter)
  - [`SkillPropertiesSchema`](#skillpropertiesschema)
  - [`SkillProperties`](#skillproperties)
- [hr-skills-ref — client](#hr-skills-ref--client)
  - [`ALLOWED_TOOLS_KEY`](#allowed_tools_key)
  - [`FRONTMATTER_DELIMITER`](#frontmatter_delimiter)
  - [`SKILL_MD_FILENAMES`](#skill_md_filenames)
  - [`MAX_SKILL_NAME_LENGTH`](#max_skill_name_length)
...
```ts
import { DocumentationSection } from 'hr-skills-build/client'
```
...
```ts
import { DocumentationSkill } from 'hr-skills-build/client'
```
...
```ts
import { DocumentationDomain } from 'hr-skills-build/client'
```
...
```ts
import { DocumentationData } from 'hr-skills-build/client'
```
