...
> Entries below `1.1.0` predate Changesets and were originally generated by an earlier Conventional-Commits-based tool. They're kept as historical record; only their headers, dates, and compare links were reformatted here for consistency — bullet content is unchanged.
