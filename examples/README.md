...
|---------|-------|---------|
| [Hiring a Senior AI Engineer](./ai/hiring-a-senior-ai-engineer.md) | `hr-ai` | LLM integration, RAG systems, agentic AI |
| [Hiring a Senior Backend Engineer](./backend/hiring-a-senior-backend-engineer.md) | `hr-backend` | API design, databases, scalability |
| [Hiring a Senior Data Engineer](./data/hiring-a-senior-data-engineer.md) | `hr-data` | Data pipelines, warehousing, analytics |
| [Hiring a Senior DevOps Engineer](./devops/hiring-a-senior-devops-engineer.md) | `hr-devops` | CI/CD, cloud infrastructure, SRE |
| [Hiring a Senior Frontend Engineer](./frontend/hiring-a-senior-frontend-engineer.md) | `hr-frontend` | Web UI, frameworks, performance |
| [Hiring a Senior Fullstack Engineer](./fullstack/hiring-a-senior-fullstack-engineer.md) | `hr-fullstack` | End-to-end product development |
| [Hiring a Senior Mobile Engineer](./mobile/hiring-a-senior-mobile-engineer.md) | `hr-mobile` | iOS, Android, cross-platform |
| [Hiring a Senior QA Automation Engineer](./qa/hiring-a-senior-qa-automation-engineer.md) | `hr-qa` | Test automation, quality engineering |
