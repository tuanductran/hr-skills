...
- prefer helpers in `packages/hr-skills-ref/src/server/` for skill
  reading/validation and in `packages/hr-skills-build/src/server/shared/` for
  build utilities; keep client helpers inside their client surface
