...
- prefer tests that exercise `packages/hr-skills-build/src/client/`,
  `packages/hr-skills-build/src/server/`, `packages/hr-skills-ref/src/client/`,
  and `packages/hr-skills-ref/src/server/` — parsing helpers, validation
  logic, registry generation, and planner/runtime logic
