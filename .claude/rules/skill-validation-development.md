---
paths:
  - packages/hr-skills-build/src/server/**/*.ts
  - packages/hr-skills-ref/src/server/**/*.ts
  - packages/hr-skills/src/cli/**/*.ts
  - packages/hr-skills-build/test/**/*.ts
  - packages/hr-skills-ref/test/**/*.ts
  - packages/hr-skills/test/**/*.ts
---

# Skill validation development rules

Use these conventions when writing or extending skill validation logic in
`packages/hr-skills-build/src/server/` and `packages/hr-skills-ref/src/server/`.
...
- prefer helpers in `packages/hr-skills-ref/src/server/` for skill reading and validation
- prefer helpers in `packages/hr-skills-build/src/server/shared/` for build utilities
