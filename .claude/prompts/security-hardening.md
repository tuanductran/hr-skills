...
- Audit `.claude/hooks/`, `packages/hr-skills-build/src/client/`,
  `packages/hr-skills-build/src/server/`, and `.github/workflows/` for shell
  safety, path safety, and least-privilege permissions.
