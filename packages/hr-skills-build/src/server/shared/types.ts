...
/** One skill invocation within an {@link ExecutionPlan}. */
...
/** Output of {@link generateExecutionPlan} — an ordered set of skills to run for a given intent. */
...
/** One problem found by {@link validateExecutionPlan} or {@link suggestPlanImprovements}. */
...
/** Result of validating an {@link ExecutionPlan}. */
...
/** Discriminates the lifecycle events emitted by {@link executeWorkflow} onto its `EventDispatcher`. */
